...
2. Replace the 3esru-tuuub-55bx5-ixfhx-di5ul-ynbq6-vcnil-byxd2-o2aeb-v5ulx-bqe in main.mo with the principal you got from step 1.

```
  let owner : Principal = Principal.fromText("3esru-tuuub-55bx5-ixfhx-di5ul-ynbq6-vcnil-byxd2-o2aeb-v5ulx-bqe");
```
